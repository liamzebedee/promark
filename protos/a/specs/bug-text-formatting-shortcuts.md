...
- Ctrl+B inserts `**` markers incorrectly and adds a vertical divider
- Formatting shortcuts do not wrap selected text properly
- (Document other specific misbehaviors observed)
